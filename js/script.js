...
const config = {
    serverInfo: {
        ...
        serverName: "Maranakinnar", /*Server name*/
        serverIp: "sgfree.exenos.cloud:25566", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1130133112920219769" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
